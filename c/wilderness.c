...
void wilderness_refuel()
{
    ...
    {
        cputsxy(5,35,"you have refueled from surface water on the mainworld (one day)");
    ...
    {
        cputsxy(7,35,"you have refueled by skimming a gas giant (five days)");
    ...
    {
        cputsxy(6,35,"you have refueled from ice in an asteroid belt (ten days)");
        pay_period += 10;
    }
    else 
    {
        cputsxy(11,35,"you have refueled at the oort cloud (two weeks)");        
        pay_period += 14;
    }
